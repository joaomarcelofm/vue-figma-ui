...
<template>
  <div>
    ...
    <FButton fullWidth danger>Button</FButton>
    <h3>Primary</h3>
    <FButton :variant="Variant.primary">Button</FButton>
    <FButton disabled :variant="Variant.primary">Button</FButton>
    <FButton danger :variant="Variant.primary">Button</FButton>
